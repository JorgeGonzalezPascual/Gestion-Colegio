 ...
 * @author marc
 */
public class Ref_asignaturas_alumnos {
    private Nodo primero;
    private Nodo vacia;

    public Ref_asignaturas_alumnos() {
        primero = null;
    }
     ...
     * @param element
     */
    public void remove_nodo(Alumno element) {
     ...
     * Quitamos el nodo que contiene el objeto curso y restructuración de lista
     *
     * @param x objeto a buscar y eliminar
     */
    public void remove_nodo(Asignatura element) {

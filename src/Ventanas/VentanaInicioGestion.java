...
public class VentanaInicioGestion extends JFrame {
    ...
    //VARIABLES GLOBALES
    private Lista_Cursos lista_global_cursos;
    private Lista_Asignaturas lista_global_asignaturas;
    private Lista_Alumnos lista_global_alumnos;
    ...
    //Constructor
    public VentanaInicioGestion(VentanaCurso vC, VentanaAsignatura vA, VentanaEstudiante vE, Lista_Cursos listaCurso, Lista_Asignaturas listaAsignatura, 
    ...
    public void setListaGlobalCursos(Lista_Cursos x){
        this.lista_global_cursos = x;
    }

    public Lista_Cursos getListaGlobalCursos(){
        return this.lista_global_cursos;
    }
    public Lista_Asignaturas getListaGlobalAsignaturas(){
        return this.lista_global_asignaturas;
    }
     public Lista_Alumnos getListaGlobalAlumnos(){
        return this.lista_global_alumnos;
        
    }
      public void setetListaGlobalAlumnos(Lista_Alumnos x){
        this.lista_global_alumnos=x;
        
    }
    public void setListaAsignaturas(Lista_Asignaturas la){
